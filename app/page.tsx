...
export default function Home() {
  ...
  const startSetup = () => { setTab('setup'); setSetupStep(0); setCreated(false); setHintsOpen(true); };
  ...
  const resetDraft = () => { setAnswers(['', '', '', '', '']); setSetupStep(0); setCreated(false); };
  ...
  return <main className="shell">
    <aside className="sidebar">
      ...
      <nav>
        ...
        <button className="nav" onClick={() => alert('Инструменты подключим после Telegram и базы данных')}>⌘ <span>Инструменты</span></button>
